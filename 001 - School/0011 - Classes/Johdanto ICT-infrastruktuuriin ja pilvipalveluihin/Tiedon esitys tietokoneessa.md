...
Kaiken yksinkertaisin numerojärjestelmä on sellainen, missä käytössä on kaksi numeroa, 0 ja 1. Puhutaan kaksikantaisesta eli binaarisesta järjestelmästä. Muissa numerojärjestelmissä numeroita nimitet