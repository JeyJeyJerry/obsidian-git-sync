...
- CPU:t tuottavat paljon lämpöä. CPU tarvitsee tehokkaan jäähdytyksen. CPU on yleensä ison jäähdytysrivan ja tuulettimen alla. Joissakin tietokoneissa käytetään eksoottisempia jäähdytysmenetelmiä, kut