...
- Moniytimisyys ja hyperthreading voivat olla käytössä samalla piirillä. Intelin kaksiytiminen prosessori sisältää kaksi ydintä, jotka voivat käyttää Hyperthreading:a. Niinpä CPU toimii (lähes) 